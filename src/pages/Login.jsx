...
const Login = () => {
  ...
  return (
    <div className="m-auto mt-20 p-4 sm:p-8 flex justify-center items-center gap-4">
      <div className="hidden sm:flex flex-col justify-center items-center w-full sm:w-[400px] h-auto sm:h-[600px] gap-5 rounded-xl drop-shadow-lg bg-emerald-100 p-8">
      ...
      <div className="w-full max-w-[400px]">
        ...
        >
          ...
          <div className="flex flex-start flex-col justify-center items-center p-6 sm:p-10 w-full max-w-[280px] gap-5">
            ...
            <button
              ...
              className="text-emerald-600 bg-white rounded-full w-full px-5 py-2 border border-emerald-600 mt-2 hover:bg-emerald-50 transition-colors"
            >
              Forgot Password?
            </button>
          </div>
